...
namespace Macaw_GH.Filtering.Extract
{
    public class BitmapProperties : GH_Component
    {
        ...
        public BitmapProperties()
          : base("BitmapProperties", "Properties", "---", "Aviary", "Bitmap Build")
        {
        }
        ...
        protected override void RegisterOutputParams(GH_Component.GH_OutputParamManager pManager)
        {
            ...
            pManager.AddIntegerParameter("Horizontal", "X", "---", GH_ParamAccess.item);
            pManager.AddIntegerParameter("Vertical", "Y", "---", GH_ParamAccess.item);
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            DA.SetData(2, A.HorizontalResolution);
            DA.SetData(3, A.VerticalResolution);
        }
