...
namespace Macaw_GH.Compose
{
    public class Composition : GH_Component
    {
        ...
        /// </summary>
        public Composition()
          : base("Compose Layers", "Compose", "---", "Aviary", "Bitmap Build")
        {
        }
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddIntervalParameter("Size", "P", "---", GH_ParamAccess.item, new Interval(0, 0));
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            foreach(IGH_Goo InputObject in X)
            {
                ...
                mLayerImage LayerObject = (mLayerImage)Z.Element;
                Layers.Add(LayerObject);
            }

            Bitmap C = null;

            mComposition CompositionObject = new mComposition(Layers, (int)P.T0, (int)P.T1);
