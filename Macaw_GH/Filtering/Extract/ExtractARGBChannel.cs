...
{
    public class ExtractARGBChannel : GH_Component
    {
        /// <summary>
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddIntegerParameter("Channel", "C", "...", GH_ParamAccess.item, 2);

            Param_Integer param = (Param_Integer)Params.Input[1];
            param.AddNamedValue("Red", 2);
            param.AddNamedValue("Green", 1);
            param.AddNamedValue("Blue", 0);
            param.AddNamedValue("Alpha", 3);
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            C = C % 3;
                    Filter = new mExtractARGBChannel((short)C);
