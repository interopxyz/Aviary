...
namespace Flock_GH.Build
{
    ...
    {
        public wCameraStandard InitialCamera = new wCameraStandard(135, 54.736, 1.0, 0, true);
      ...
      : base("ViewPointCloud", "Point Cloud", "---", "Aviary", "3D View")
        {
        }
        ...
        {
            InitialCamera = new wCameraStandard(135, 54.736, 1.0, 0, true);
        ...
        {
            InitialCamera = new wCameraStandard(45, 54.736, 1.0, 0, true);
        ...
        {
            InitialCamera = new wCameraStandard(235, 54.736, 1.0, 0, true);
        ...
        {
            InitialCamera = new wCameraStandard(315, 54.736, 1.0, 0, true);
        ...
        {
            InitialCamera = new wCameraStandard(0, 0, 1.0, 0, true);
        ...
        {
            InitialCamera = new wCameraStandard(0, 180, 1.0, 0, true);
        ...
        {
            InitialCamera = new wCameraStandard(180, 90, 1.0, 0, true);
        ...
        {
            InitialCamera = new wCameraStandard(0, 90, 1.0, 0, true);
        ...
        {
            InitialCamera = new wCameraStandard(270, 90, 1.0, 0, true);
