...
{
    public class CheckList : GH_Component
    {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (Active)
            {
                if (Elements[C] != null)
                {
                    ...
                    pCtrl = (pChecklist)Element.ParrotControl;
                }
            }
            else
            {
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                return Properties.Resources.Parrot_CheckList;
            }
        }
        ...
        {
            get { return new Guid("{f9c16d02-4eca-4f66-a92f-c07db8280d7b}"); }
        }
    }
}